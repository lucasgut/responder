...
public class ResourceHandler {
    ...
    private static final String NOT_FOUND_MSG = "No version %s found for resource %s";
    ...
    private Version doGetVersion(Resource resource, List<Version> versions, String versionName) throws ResourceNotFoundException {
        ...
        throw new ResourceNotFoundException(String.format(NOT_FOUND_MSG, versionName, resource.getName()),
