...
class T24StandingOrderTest extends Specification {
    ...
    def "T24 customer information command"(id, map) {
        ...
        where:
            id   | map
            200  | ['ID': 200, 'TARGET.ACCOUNT': 'GB91 BKEN 1000 0041 6100 08', 'AMOUNT': 1200.0]
            400  | ['ID': 400, 'TARGET.ACCOUNT': 'GB27 BOFI 9021 2729 8235 29', 'AMOUNT': 2020.0]
            401  | ['ID': 401, 'TARGET.ACCOUNT': 'GB29 NWBK 6016 1331 9268 19', 'AMOUNT': 2000.0]
            402  | ['ID': 402, 'TARGET.ACCOUNT': 'GB29 NWBK 6016 1331 9268 53', 'AMOUNT': 4000.0]
    }
