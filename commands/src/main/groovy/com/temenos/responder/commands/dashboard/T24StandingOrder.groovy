 ...
 * {@link com.temenos.responder.scaffold.dashboard.T24StandingOrder scaffold of a T24 account}.
 *
 * @author aburgos
 */
    ...
    void execute(CommandContext context) {
        try {
            ...
            if(standingOrderId == "200") {
                map.put("ID", 200)
                map.put("TARGET", "GB91 BKEN 1000 0041 6100 08")
                map.put("AMOUNT", 1200)
            } else if(standingOrderId == "400") {
                map.put("ID", 400)
                map.put("TARGET", "GB27 BOFI 9021 2729 8235 29")
                map.put("AMOUNT", 2020)
            } else if(standingOrderId == "401") {
                map.put("ID", 401)
                map.put("TARGET", "GB29 NWBK 6016 1331 9268 19")
                map.put("AMOUNT", 2000)
            } else if(standingOrderId == "402") {
                map.put("ID", 402)
                map.put("TARGET", "GB29 NWBK 6016 1331 9268 53")
                map.put("AMOUNT", 4000)
            }
